...
import static app.util.RequestUtil.clientAcceptsCSS;
...
public class Filters {
    ...
    // Enable CSS for all stylesheets
    public static Filter addCssMimeType = (Request request, Response response) -> {
        if (clientAcceptsCSS(request)){
